...
const NAV_ITEMS = [
    ...
    { id: 'moderation', icon: ShieldAlert, label: 'Moderation', path: '/admin/moderation' },
    { id: 'selfie-verification', icon: ScanFace, label: 'Selfie Verification', path: '/admin/selfie-verification' },
    { id: 'reports', icon: Flag, label: 'Reports & Flags', path: '/admin/reports' },
    { id: 'support', icon: LifeBuoy, label: 'Support Management', path: '/admin/support' },
    { id: 'subscriptions', icon: CreditCard, label: 'Subscriptions Edit', path: '/admin/subscriptions' },
    { id: 'boost-edit', icon: Zap, label: 'Boost Edit', path: '/admin/boost-edit' },
    { id: 'subscription-users', icon: UserCheck, label: 'Subscription Users', path: '/admin/subscription-users' },
    ...
    { id: 'app-config', icon: SlidersHorizontal, label: 'App Config', path: '/admin/app-config' },
    { id: 'profile', icon: UserCircle, label: 'My Profile', path: '/admin/profile' },
];
...
const AdminSidebar = () => {
    ...
    const showWebsitePages = hasPermission('website-pages');
